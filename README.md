...
_Ensure the configurations match `compose.yml`._
...
_Wait until all containers are in `healthy` state._
...
├── config/              # Configuration (DB, Redis, MinIO, Logger)
...
- **Super Admin Account:**
  ...
  - Password: `admin123` _(Created during seeding)_
